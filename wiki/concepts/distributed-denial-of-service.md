...
2.  **Mạng máy tính ma (Botnet)**: Một mạng lưới các thiết bị bị xâm nhập (máy tính, máy chủ, thiết bị [[iot-security|IoT]]) nằm rải rác ở nhiều nơi, được điều khiển từ xa bởi kẻ tấn công.
...
- [[iot-security|An ninh Internet vạn vật]]

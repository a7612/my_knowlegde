...
Sau khi có [[windows-initial-access|truy cập ban đầu]], bước tiếp theo là tìm hiểu sâu về cấu trúc bên trong của máy chủ Windows để chuẩn bị cho việc leo thang đặc quyền.

...
**Truy cập ban đầu (Initial Access)** là bước ngoặt trong quy trình [[penetration-testing|kiểm thử xâm nhập]], khi chuyên gia tận dụng các lỗ hổng đã phát hiện để giành được quyền thực thi lệnh trên hệ thống mục tiêu.
...
## Liên kết liên quan
- [[linux-information-gathering|Thu thập thông tin (Linux)]]
- [[vulnerability-assessment|Đánh giá lỗ hổng]]
- [[linux-system-enumeration|Liệt kê hệ thống (Linux)]]

...
Sử dụng Shell cho phép tự động hóa các quy trình thông qua các tập lệnh (scripts), giúp công việc thủ công trở nên nhanh chóng và hiệu quả hơn. Hầu hết các lệnh trong shell đều được tài liệu hóa chi tiết trong [[linux-man-pages|Hệ thống trang hướng dẫn Linux (Man Pages)]].

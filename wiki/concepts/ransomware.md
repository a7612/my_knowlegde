...
1.  **Xâm nhập**: Kẻ tấn công thường sử dụng [[social-engineering|Phishing]] (email lừa đảo) chứa liên kết hoặc tệp đính kèm độc hại.
...
- [[linux-backup-restore|Sao lưu và khôi phục]]

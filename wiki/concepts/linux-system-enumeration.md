...
**Liệt kê hệ thống (System Enumeration)** là quá trình thu thập thông tin chi tiết từ bên trong hệ thống sau khi đã giành được [[linux-initial-access|truy cập ban đầu]]. Đây là bước nền tảng của giai đoạn **Hậu khai thác (Post-Exploitation)**.
...
## Liên kết liên quan
- [[linux-initial-access|Truy cập ban đầu (Linux)]]
- [[linux-vulnerability-assessment|Đánh giá lỗ hổng (Linux)]]
- [[linux-privilege-escalation|Leo thang đặc quyền (Linux)]]

...
1.  **[[pentest-pre-engagement|Tiền dự án (Pre-Engagement)]]**: Thảo luận, xác định phạm vi, ký kết các văn bản pháp lý và chuẩn bị quyền hạn cần thiết.
2.  **[[information-gathering|Thu thập thông tin (Information Gathering)]]**: Thu thập dữ liệu về mục tiêu để hiểu cấu trúc, chức năng và các nguồn lực kỹ thuật. Quá trình này bao gồm [[osint|OSINT]] và [[network-scanning|Quét mạng]].
3.  **[[vulnerability-assessment|Đánh giá lỗ hổng (Vulnerability Assessment)]]**: Phân tích thông tin đã thu thập để xác định các vector tấn công tiềm năng và các "low-hanging fruits".
4.  **[[exploitation|Khai thác (Exploitation)]]**: Tấn công trực tiếp vào các lỗ hổng và vượt qua các cơ chế phòng thủ (Ví dụ: [[linux-initial-access|Truy cập ban đầu trên Linux]], [[windows-initial-access|Truy cập ban đầu trên Windows]]).
5.  **[[post-exploitation|Sau khai thác (Post-Exploitation)]]**: Kiểm soát hệ thống từ bên trong, thu thập thông tin nội bộ và leo thang đặc quyền (Ví dụ: [[linux-system-enumeration|Liệt kê hệ thống]], [[linux-vulnerability-assessment|đánh giá lỗ hổng nội bộ]], [[linux-privilege-escalation|leo thang đặc quyền]] và [[linux-pillaging|vét cạn dữ liệu]] trên Linux; và các bước tương tự trên [[windows-system-enumeration|Windows]]).
6.  **[[lateral-movement|Di chuyển ngang (Lateral Movement)]]**: Sử dụng hệ thống đã chiếm được để di chuyển sâu hơn vào mạng nội bộ.
7.  **[[proof-of-concept|Bằng chứng khai thác (Proof-of-concept)]]**: Ghi lại các bước thực hiện kỹ thuật để khách hàng có thể tái hiện và xác nhận lỗ hổng.
8.  **[[post-engagement|Hậu dự án (Post-Engagement)]]**: Bao gồm việc lập [[pentest-documentation|báo cáo dự án]], [[pentest-reporting|trình bày kết quả]] và hỗ trợ khách hàng khắc phục lỗ hổng.
...
- [[cybersecurity-teams|Các đội ngũ an ninh mạng]] (Đặc biệt là [[cybersecurity-teams|Red Team]])

...
### Mục tiêu:
*   Phòng ngừa và giám sát liên tục (thông qua [[dns-service|SIEM]], [[distributed-denial-of-service|IDS]], EDR).
...
### Cách thức hoạt động:
*   **Tiếp cận toàn diện**: Không chỉ tìm lỗi kỹ thuật mà còn sử dụng [[social-engineering|tấn công kỹ thuật xã hội]] và kiểm tra an ninh vật lý.

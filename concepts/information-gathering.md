...
## 2. Quét mạng và dịch vụ ([[my_knowlegde/concepts/network-scanning|Scanning]])
...
*   **Công cụ**: [[my_knowlegde/concepts/network-scanning|Nmap]] là công cụ phổ biến nhất cho nhiệm vụ này.
...
- [[my_knowlegde/concepts/osint|Tình báo nguồn tin công khai (OSINT)]]
- [[my_knowlegde/concepts/network-scanning|Quét mạng và dịch vụ]]
- [[my_knowlegde/concepts/pentest-pre-engagement|Giai đoạn Tiền dự án]]

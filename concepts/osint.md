...
**OSINT** là quá trình thu thập và phân tích thông tin từ các nguồn công khai có sẵn để hiểu rõ về một tổ chức hoặc cá nhân. Trong [[my_knowlegde/concepts/penetration-testing|kiểm thử xâm nhập]], OSINT giúp chuyên gia xây dựng bức tranh toàn cảnh về hạ tầng kỹ thuật và con người của mục tiêu trước khi thực hiện các kỹ thuật tấn công trực tiếp.
...
*   **Hỗ trợ tấn công tâm lý**: Sử dụng thông tin về nhân viên và văn hóa công ty để tạo ra các kịch bản [[my_knowlegde/concepts/social-engineering|tấn công kỹ thuật xã hội]] thuyết phục hơn.

## Liên kết liên quan
- [[my_knowlegde/concepts/information-gathering|Thu thập thông tin]]

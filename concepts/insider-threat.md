...
2.  **Kẻ nội bộ sơ suất (Negligent Insiders)**: Những cá nhân không có ý định gây hại nhưng lại làm vậy do bất cẩn hoặc thiếu hiểu biết. Ví dụ: gửi nhầm email chứa thông tin mật hoặc rơi vào bẫy [[my_knowlegde/concepts/social-engineering|tấn công kỹ thuật xã hội]].
...
*   **Hệ quả pháp lý**: Vi phạm các quy định như [[my_knowlegde/concepts/information-security|GDPR, HIPAA]] dẫn đến các khoản phạt nặng và kiện tụng.

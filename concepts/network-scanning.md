...
**Quét mạng và dịch vụ** là bước kỹ thuật nền tảng trong [[my_knowlegde/concepts/penetration-testing|kiểm thử xâm nhập]]. Giai đoạn này giúp chuyên gia xác định các máy chủ đang hoạt động, các cổng mở và các dịch vụ đang chạy trong phạm vi được cho phép để lập bản đồ bề mặt tấn công.
